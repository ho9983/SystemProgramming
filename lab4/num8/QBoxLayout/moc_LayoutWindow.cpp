...
const QMetaObject LayoutWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_LayoutWindow.data,
      qt_meta_data_LayoutWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *LayoutWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LayoutWindow.stringdata0))
        return static_cast<void*>(const_cast< LayoutWindow*>(this));
